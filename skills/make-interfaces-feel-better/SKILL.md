...
Vendored from [jakubkrehel/make-interfaces-feel-better](https://github.com/jakubkrehel/make-interfaces-feel-better) by [Jakub Krehel](https://github.com/jakubkrehel). MIT — see [LICENSE](LICENSE).
